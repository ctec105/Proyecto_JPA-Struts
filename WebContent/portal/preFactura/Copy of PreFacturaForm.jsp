...
<s:form  theme="simple">
	...
	<table>
		<s:if test="prefactura.id!=0">
				<tr>
				<th>Codigo:</th>
			 	<td><s:textfield name="prefactura.id" readonly="true"  key="Codigo"  readonly="true" /></td>
			 	</tr>
		</s:if>
		<tr>
			<th>Usuario:</th>
		...
		<tr>
			...
			<td><s:textfield id="buscOrden"  name="prefactura.liquidacion.id"  requiredposition="left" />
			...
			<tr>
				<td colspan="4">
					<dt:table  name="detalles" id="bean" class="simple" requestURI="CargaDatosLiq" pagesize="50">
						...
						<dt:column property="item" title="ITEM/Tecnico" sortable="true" ></dt:column>
						<dt:column property="descripcion" title="nombre Item/Tecnico" sortable="true" ></dt:column>
						<dt:column property="precio_unitario" title="Precio Un." sortable="true"> </dt:column>
