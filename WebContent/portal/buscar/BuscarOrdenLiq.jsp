...
function enviaDatos(){
	try{
		...
		if(document.forms[0].cod.length == undefined){
			opener.document.forms[0].clienteBusc.value = document.forms[0].cod.value;
		} 
		else{ 
			...
			opener.document.forms[0].clienteBusc.value = document.forms[0].cod[i].value; 
		}
		window.close();
	}catch(e){
		alert(e.value);
...
<div class="content">
     ...
     <div class="Post-inner"  style="height: 330px">
		...
		<input type="hidden" name="metodo" >
        	<table>
				<tr>
					<td><s:text name="RUC"></s:text> </td>
					<td><s:textfield name="cliente.id"/> </td>
				</tr>
				<tr>
					<td><s:text name="Nombre/Razon Social"></s:text> </td>
					<td> <s:textfield name="cliente.razonSoc"/> </td>
				</tr>
				<tr>
					<td colspan="2" align="center">
						<s:submit action="popBuscarLiquidacion" value="Buscar" />
					</td>
				</tr>
			</table>
			

			<dt:table  name="trabajos" id="bean" class="simple" requestURI="redireccion.do?metodo=trabajo" pagesize="10">
